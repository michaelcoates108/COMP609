...
namespace OverallApp
{
    class Cow : Animal
    {
        ...
        public Cow(int id, double waterAmount, double cost, double weight, int age, String colour,
            double milkAmount, bool isJersey) : base(id, waterAmount, cost, weight, age, colour)
        {
        ...
        {
            //The profitability of a livestock is calculated as the income from milk minus the costs.
            double income = (this.milkAmount * Prices.cowMilkPrice) - this.cost - (this.waterAmount * Prices.waterPrice) - GetTax();
            return income;
        }
